...
const BlogCards = () => {
    return (
        <>
            <h2 className="text-3xl flex items-center justify-center text-emerald-700 font-semibold m-4">                 <RiArticleFill className='text-4xl mr-3 text-yellow-500' /> Tourist Blogs
            </h2>
