...
//     return (
//         <div className="relative h-screen m-[7%]">
//             <div className="relative h-1/3 w-full">
//                 <img src={scene3} className="h-full w-full object-cover opacity-30" alt="Background" />
//                 <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center text-white">
//                     <h1 className="text-3xl md:text-5xl font-bold mb-2">{blog.title}</h1>
//                     <p className="text-lg md:text-2xl">{blog.user}</p>
//                 </div>
//             </div>
//             <div className="mt-7">
//                 <hr />
