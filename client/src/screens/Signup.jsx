      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center bg-black bg-opacity-20">
        ...
        <div className="bg-indigo-900 bg-opacity-60 p-8 rounded-lg shadow-lg w-full max-w-md">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
              ...
              <>
                <div className="relative z-0 w-full group">
                  <input
                    ...
                    name="name"
                    id="name"
                    className="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:ring-0 focus:border-blue-600 peer"
                    placeholder=" "
                    value={values.name}
                    onChange={handleChange}
                    onBlur={handleBlur}
            ...
            <button type="submit" className="text-white flex underline float-right">
              Sign Up
            </button>
            <br />
            {errorMessage && (
